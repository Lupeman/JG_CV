    ...
    return (
      <div className="contact_details_container">
        <div className="website">
          <ul>
            <li>
              <img id="website" src="/Users/jaimegunther/JG_2017_CV/app/images/browser.png" alt="portfolio_site_icon" /></li>
        ...
        <div className="mobile">
          <ul>
            <li>
              <img id="mobile" src="/app/images/mobile.png" alt="mobile_contact_icon" />
            </li>
            <li>
              <p>0406 052 463</p>
            </li>
        ...
        <div className="email">
          <ul>
            <li>
              <img id="email" src="/app/images/email.png" alt="email icon" />
            </li>
            <li>
