  ...
  render: function(){
    return(
      <div className="personal_statement_container">
        <p>
          <span>“C</span>urrently in my final week of the Web Development Immersive Program, I have recently made the all important leap into pursuing my passion for coding full-time. Throughout my diverse career, I have been able to take from each pursuit a new skill set. I am a confident, inquisitive, kind and determined individual always striving to learn something new and see how it can be applied. My interest in learning is what lead me to coding - as I was looking for another way to challenge myself. It has also taught me that there is always more to know and many experienced people out there, who can help teach, mould and advise.</p>
